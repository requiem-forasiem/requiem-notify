...
class RequiemStatusIcon:
        ...
        def configure(self, widget):
                dialog = gtk.Dialog("Configure requiem notify", None, 0,
                        (gtk.STOCK_OK, gtk.RESPONSE_OK,
                         gtk.STOCK_CANCEL, gtk.RESPONSE_CANCEL))

                profile_entry      = gtk.Entry()
                confutatis_url_entry = gtk.Entry()
                ...
                label = gtk.Label("Confutatis URL: ")
                table.attach(label, 0, 1, 5, 6)
                confutatis_url_entry.set_text(self.config.get("confutatis", "url"))
                table.attach(confutatis_url_entry, 1, 2, 5, 6)
                ...
                if response == gtk.RESPONSE_OK:
                        ...
                        self.config.set("confutatis", "url", confutatis_url_entry.get_text())
        ...
        def about(self, widget):
                ...
                try:
                        dialog.set_program_name("Requiem Notify")
                ...
                try:
                        dialog.set_comments("Systray Notification for Requiem")
                except AttributeError:
